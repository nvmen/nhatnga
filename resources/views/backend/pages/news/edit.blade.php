                        ...
                        <div class="form-group">
                            <label for="name_en">Short Description (Vi)</label>
                                    <textarea class="form-control" id="short_des_vi" name="short_des_vi"
                                              placeholder="Short Description (Vi)">{{$news_vi->short_description}}
                                    </textarea>
                        ...
                        <div class="form-group">
                            <label for="name_en">Short Description (En)</label>
                                    <textarea class="form-control" id="short_des_en" name="short_des_en"
                                              placeholder="Short Description (En)">{{$news_en->short_description}}
                                    </textarea>
                        </div>
...
<script>
    var global_files = [];
    var global_media = [{{$news->media_ids}}];
    ...
    function save_edit() {
        ...
        var old_media_id ='{{$news->media_ids}}';
        ...
        //  console.log('===========>',obj)
        show_spinner();
        $.post('{{route('backend.news.edit')}}', obj)
    .done(function (data) {
            hide_spinner();
