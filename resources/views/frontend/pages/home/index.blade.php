                        ...
                        <aside id="travel_login_register_from-2" class="widget widget_login_form">
                            ...
                            <div class="form_popup from_login" tabindex="-1">
                                <div class="inner-form">
                                    ...
                                    <a href="index.htm#" title="Lost your password?" class="lost-pass">Lost your password?</a>
                                </div>
                            </div>
                                    ...
                                    <div class="item_content">
                                        <div class="post_images">
                                            ...
                                            <div class="group-icon">
                                                <a href="index.htm#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="River Cruise"><i class="flaticon-transport-2"></i></a>
                                                <a href="index.htm#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wildlife"><i class="flaticon-island"></i></a>
                                            </div>
                                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-center padding-top-6x">
                            <a href="javascript:if(confirm('https://themeforest.net/item/travel-html-tour-travel-html-template-for-travel-agency-and-tour-operator/19504894\n\nThis file was not retrieved because it was filtered out by your project settings.\n\nWould you like to open it from the server?'))window.location='https://themeforest.net/item/travel-html-tour-travel-html-template-for-travel-agency-and-tour-operator/19504894'" class="icon-btn" title="Tour HTML Template - Travel HTML Template" target="_blank">
                        ...
                        <div class="col-sm-8">
                            <div class="discounts-tour">
                                ...
                                <div class="col-sm-12 text-center padding-top-2x">
                                    <a href="index.htm#" class="icon-btn"><i class="flaticon-airplane-4"></i> Get tour </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-2"></div>
