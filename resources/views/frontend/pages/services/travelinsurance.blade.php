...
@section('pageTitle',  __('home.domestic_and_international_travel_insurance'))
@section('content')
            ...
            <div class="banner-wrapper container article_heading">
                <div class="breadcrumbs-wrapper">
                    <ul class="phys-breadcrumb">
                        ...
                        <li>{{__('home.domestic_and_international_travel_insurance')}}</li>
                    </ul>
                </div>
                <h1 class="heading_primary">{{__('home.domestic_and_international_travel_insurance')}}</h1></div>
        </div>
